...
function removePageLoadVideos() 
{
    // if (window.innerWidth > 767) 
    // {
    //     document.querySelectorAll(".page-load-vid-alt.mobile").forEach(el => el.remove());
    //     document.querySelectorAll(".page-load-vid-alt-dest.mobile").forEach(el => el.remove());
    // } 
    // else 
    // {
    //     document.querySelectorAll(".page-load-vid-alt.desktop").forEach(el => el.remove());
    //     document.querySelectorAll(".page-load-vid-alt-dest.desktop").forEach(el => el.remove());
    // }
...
barba.hooks.once(async (data)=>{
    // ................................ VIDEOS ................................
//     $('.page-load-vid').each(function(idx, el){
...
//                 gsap.to($('.page-load-vid'),{
//                     opacity: 1,
//                     duration: 0.75,
//                     ease: 'power2.inOut'
//                 })
//                 gsap.to($('.page-load-vid').siblings('.cover-img'),{
//                     opacity: 0,
//                     duration: 0.75,
//                     ease: 'power2.inOut'
//                 })
...
//     })
    ...
    await new Promise(resolve => {
        // $('.nav').load(`${window.location.pathname} .nav-wrap`, ()=>{
        navInit()
        resolve()
        // })
    }) 
    ...
    // await pageLoad(active.page)

    // active.pageLoad = new pageClasses['Load'](data)
    
    // await active.pageLoad.launch()
    // await active.pageLoad.intro()
})
...
barba.hooks.afterEnter(async (data)=>{
 ...
 footerInit(data);
    ...
    //tiago - no desespero de fazer a pagina funcionar
